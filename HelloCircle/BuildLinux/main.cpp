...
"If x64: ./display-x64 | ./HelloCircle shared-fb\n"
"If ARM: ./display-arm | ./HelloCircle shared-fb\n\n"

"How to run on Linux?\n"
"Type command: ./HelloCircle /dev/fb-path\n\n"
"-------------------- Help ------------------------\n"
"exit: 	Exit the App.\n"
"--------------------------------------------------\n";
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh HelloCircle");
	...
	init_std_io();
	startHelloCircle(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    return 0;
}
