...
"./xWindow 240 320 | ./Hello3Ddonut shared-fb\n\n"

"Run on ARM Linux:\n"
"./Hello3Ddonut /dev/fb-path\n"
"------------------------------------------------------------\n";
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh Hello3Ddonut &");
	...
	init_std_io();
	startHello3Ddonut(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    return 0;
}
