...
"If x64: ./display-x64 | ./HelloWave shared-fb\n"
"If ARM: ./display-arm | ./HelloWave shared-fb\n\n"

"How to run on Linux?\n"
"Type command: ./HelloWave /dev/fb-path\n\n"
"-------------------- Help ------------------------\n"
...
int main(int argc, char** argv)
{
	...
	init_std_io();
	startHelloWave(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    return 0;
}
