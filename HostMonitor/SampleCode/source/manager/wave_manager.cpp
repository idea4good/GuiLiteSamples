...
{	/*wave data*/  /*name*/ /*unit*/	/*name_font*/  		/*unit_font*/      /*name_color*/		/*unit_color*/		  /*wave_color*/			/*max*/		/*min*/  /*pivot*/ /*sample rate*/
	{ WAVE_ECG1,	"I",	NULL,		FONT_ENG_SMB_AA,	FONT_ENG_SB,	   GLT_RGB(0,255,0),		GLT_RGB(0,255,0),	  GLT_RGB(0,255,0),		 190,        60,    	128,	DEMO_ECG_WAVE_SPEED },
	{ WAVE_ECG2,	"II",	NULL,		FONT_ENG_SMB_AA,	FONT_ENG_SB,	   GLT_RGB(0,255,0),		GLT_RGB(0,255,0),	  GLT_RGB(0,255,0),      190/*240*/, 60/*10*/,	128,	DEMO_ECG_WAVE_SPEED },
	{ WAVE_ECG3,	"III",	NULL,		FONT_ENG_SMB_AA,	FONT_ENG_SB,	   GLT_RGB(0,255,0),		GLT_RGB(0,255,0),	  GLT_RGB(0,255,0),      190,        60,    	128,	DEMO_ECG_WAVE_SPEED },
	{ WAVE_ECG4,	"AVR",	NULL,		FONT_ENG_SMB_AA,	FONT_ENG_SB,	   GLT_RGB(0,255,0),		GLT_RGB(0,255,0),	  GLT_RGB(0,255,0),      190,        60,    	128,	DEMO_ECG_WAVE_SPEED },
	{ WAVE_ECG5,	"AVL",	NULL,		FONT_ENG_SMB_AA,	FONT_ENG_SB,	   GLT_RGB(0,255,0),		GLT_RGB(0,255,0),	  GLT_RGB(0,255,0),      190,        60,    	128,	DEMO_ECG_WAVE_SPEED },
	{ WAVE_ECG6,	"AVF",	NULL,		FONT_ENG_SMB_AA,	FONT_ENG_SB,	   GLT_RGB(0,255,0),		GLT_RGB(0,255,0),	  GLT_RGB(0,255,0),      190,        60,    	128,	DEMO_ECG_WAVE_SPEED },
	{ WAVE_ECG7,	"V",	NULL,		FONT_ENG_SMB_AA,	FONT_ENG_SB,	   GLT_RGB(0,255,0),		GLT_RGB(0,255,0),	  GLT_RGB(0,255,0),      190,        60,    	128,	DEMO_ECG_WAVE_SPEED },
	{ WAVE_SPO2,	"SPO2",	NULL,		FONT_ENG_SMB_AA,	FONT_ENG_SB,	   GLT_RGB(41,189,189),		GLT_RGB(131,129,131), GLT_RGB(41,189,189),   128,        0, 		64,		DEMO_SPO2_WAVE_SPEED},
	{ WAVE_RESP,	"RESP",	NULL,		FONT_ENG_SMB_AA,	FONT_ENG_SB,	   GLT_RGB(255,255,0),		GLT_RGB(255,255,0),	  GLT_RGB(255,255,0),    255,        0,    		128,	DEMO_RESP_WAVE_SPEED}
};
