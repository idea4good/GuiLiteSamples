...
extern void startHello2Layers(void* phy_fb, int width, int height, int color_bytes, struct EXTERNAL_GFX_OP* gfx_op);
...
int main(void)
{
	...
	startHello2Layers(NULL, 240, 320, 2, &my_gfx_op);
	while(1);
}
