...
4. Link your LCD driver with GuiLite, and call UI entry function(e.g, startHelloStar)
...
- `sudo ./HelloStar /dev/fb0`&nbsp;&nbsp;&nbsp;&nbsp;/dev/fb0: The path of framebuffer device file.

3. Run inside QT APP(display-xxx is a QT APP for display, skip this if you haven't installed QT):
- If x64: `sudo ./display-x64 1 240 320 | ./HelloStar shared-fb`
- If ARM/Raspberry Pi: `sudo ./display-arm  1 240 320 | ./HelloStar shared-fb`
...
2. How to run HelloStar on ARM Linux device?
- Copy HelloStar you build on ARM Linux device
