...
"If x64: ./display-x64 | ./HelloTimer shared-fb\n"
"If ARM: ./display-arm | ./HelloTimer shared-fb\n\n"

"How to run on Linux?\n"
"Type command: ./HelloTimer /dev/fb-path\n\n"
"-------------------- Help ------------------------\n"
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh HelloTimer");
	...
	init_std_io();
	startHelloTimer(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    return 0;
}
