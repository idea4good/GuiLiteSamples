// HelloSlide.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "UiBlock.h"
#include "HelloSlide.h"
#include <windowsx.h>
#include <shellapi.h>
...
DWORD WINAPI ThreadHelloSlide(LPVOID pParam);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HelloSlide, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HelloSlide));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HelloSlide));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HelloSlide);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD threadID;
   CreateThread(NULL, 0, ThreadHelloSlide, NULL, 0, &threadID);
...
//////////////////////// HelloSlide Interface ////////////////////////
void startHelloSlide(void* phy_fb, int width, int height, int color_bytes);

DWORD WINAPI ThreadHelloSlide(LPVOID pParam)
{
	startHelloSlide(calloc(512 * 768, COLOR_BYTES), 512, 768, COLOR_BYTES);
	return 0;
}
