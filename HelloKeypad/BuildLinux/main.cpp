...
"./xWindow 240 320 | ./HelloKeypad shared-fb\n\n"

"Run on ARM Linux:\n"
"./HelloKeypad /dev/fb-path\n\n"
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh HelloKeypad > /dev/null 2>&1 &");
	...
	init_std_io();
	startHelloKeypad(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    while(1)
    {
    	sleep(1000);
    }
