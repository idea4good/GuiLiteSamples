...
"If x64: ./display-x64 | ./HelloScroll shared-fb\n"
"If ARM: ./display-arm | ./HelloScroll shared-fb\n\n"

"How to run on Linux?\n"
"Type command: ./HelloScroll /dev/fb-path\n\n"
"-------------------- Help ------------------------\n"
"exit: 	Exit the App.\n"
"--------------------------------------------------\n";
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh HelloScroll");
	...
	init_std_io();
	startHelloScroll(phy_fb, screen_width, screen_height, color_bytes);//never return;
    return 0;
}
