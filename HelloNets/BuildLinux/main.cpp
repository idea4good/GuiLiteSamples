...
extern "C" void startHelloNets(void* phy_fb, int width, int height, int color_bytes);
...
"If x64: ./display-x64 | ./HelloNets shared-fb\n"
"If ARM: ./display-arm | ./HelloNets shared-fb\n\n"

"How to run on Linux?\n"
"Type command: ./HelloNets /dev/fb-path\n\n"
"-------------------- Help ------------------------\n"
"exit: 	Exit the App.\n"
"--------------------------------------------------\n";
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh HelloNets");
	...
	init_std_io();
	startHelloNets(phy_fb, screen_width, screen_height, color_bytes);//never return;
    return 0;
}
