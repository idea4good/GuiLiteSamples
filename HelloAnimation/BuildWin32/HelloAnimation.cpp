// HelloAnimation.cpp : Defines the entry point for the application.
//
...
DWORD WINAPI ThreadHelloAnimation(LPVOID pParam);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HelloAnimation, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HelloAnimation));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HelloAnimation));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HelloAnimation);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD threadID;
   CreateThread(NULL, 0, ThreadHelloAnimation, NULL, 0, &threadID);
...
//////////////////////// HelloAnimation Interface ////////////////////////
void startHelloAnimation(void* phy_fb, int width, int height, int color_bytes);

DWORD WINAPI ThreadHelloAnimation(LPVOID pParam)
{
	startHelloAnimation(calloc(238 * 169, COLOR_BYTES), 238, 169, COLOR_BYTES);
	return 0;
}
