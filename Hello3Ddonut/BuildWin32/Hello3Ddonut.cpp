// Hello3Ddonut.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "UiBlock.h"
#include "Hello3Ddonut.h"
#include <windowsx.h>
#include <shellapi.h>
...
DWORD WINAPI ThreadHello3Ddonut(LPVOID pParam);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_Hello3Ddonut, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_Hello3Ddonut));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_Hello3Ddonut));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_Hello3Ddonut);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD threadID;
   CreateThread(NULL, 0, ThreadHello3Ddonut, NULL, 0, &threadID);
