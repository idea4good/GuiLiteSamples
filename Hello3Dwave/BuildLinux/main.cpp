...
"./xWindow 240 320 | ./Hello3Dwave shared-fb\n\n"

"Run on ARM Linux:\n"
"./Hello3Dwave /dev/fb-path\n"
"------------------------------------------------------------\n";
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh Hello3Dwave > .sync_log.txt 2>&1 &");
	...
	init_std_io();
	startHello3Dwave(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    return 0;
}
