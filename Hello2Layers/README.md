...
1. Open "Hello2Layers\BuildMFC\Hello2Layers.sln" by Visual studio 2017
2. Click `F5` to build/run `Hello2Layers`
...
## Build
1. Open "Hello2Layers\BuildSTM32F103-Keil\USER\Hello2Layers.uvprojx" with Keil uvsion.
2. Choose your Device type(Default: STM32F103ZE) from option for target.
3. Build Hello2Layers.
...
4. Link your LCD driver with GuiLite, and call UI entry function(e.g, startHello2Layers)
5. Build & Run
...
2. Run locally(e.g, Ubuntu):
    - Run with framebuffer: `sudo ./Hello2Layers /dev/fb0`&nbsp;&nbsp;&nbsp;&nbsp;/dev/fb0: The path of framebuffer device file.
    - Run inside X Window:
        1. `sudo su`
        2. `sudo ipcrm -M 1`
        3. `sudo ./xWindow 240 320 | ./Hello2Layers shared-fb`
...
3. Run on target Linux device:
    - Copy BuildLinux/Hello2Layers to target Linux device
    - `chmod 777 Hello2Layers`
    - `sudo ./Hello2Layers /dev/fb0`&nbsp;&nbsp;&nbsp;&nbsp;/dev/fb0: The path of framebuffer
