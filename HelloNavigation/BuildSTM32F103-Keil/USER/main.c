...
extern void startHelloNavigation(void* phy_fb, int width, int height, int color_bytes, struct EXTERNAL_GFX_OP* gfx_op);
extern void sendKey2HelloNavigation(unsigned int key);
