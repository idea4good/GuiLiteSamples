...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh HelloPendulum > .sync_log.txt 2>&1 &");
	...
	init_std_io();
	startHelloPendulum(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    return 0;
}
