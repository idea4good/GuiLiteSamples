// Hello3Dwave.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "UiBlock.h"
#include "Hello3Dwave.h"
#include <windowsx.h>
#include <shellapi.h>
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_Hello3Dwave, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_Hello3Dwave));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_Hello3Dwave));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_Hello3Dwave);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD threadID;
   CreateThread(NULL, 0, ThreadHello3Dwave, NULL, 0, &threadID);
...
DWORD WINAPI ThreadHello3Dwave(LPVOID pParam)
{
	startHello3Dwave(calloc(240 * 320, COLOR_BYTES), 240, 320, COLOR_BYTES, 0);
	return 0;
}
