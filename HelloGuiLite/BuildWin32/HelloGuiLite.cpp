// HelloGuiLite.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "UiBlock.h"
#include "HelloGuiLite.h"
#include <windowsx.h>
#include <shellapi.h>
...
DWORD WINAPI ThreadHelloGuiLite(LPVOID pParam);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HelloGuiLite, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HelloGuiLite));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HelloGuiLite));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HelloGuiLite);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD threadID;
   CreateThread(NULL, 0, ThreadHelloGuiLite, NULL, 0, &threadID);
...
//////////////////////// HelloGuiLite Interface ////////////////////////
void start_helloGL(void* phy_fb, int width, int height, int color_bytes);

DWORD WINAPI ThreadHelloGuiLite(LPVOID pParam)
{
    start_helloGL(calloc(1280 * 720, COLOR_BYTES), 1280, 720, COLOR_BYTES);
	return 0;
}
