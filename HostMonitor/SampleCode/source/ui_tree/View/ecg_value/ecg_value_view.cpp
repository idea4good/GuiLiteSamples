...
void c_ecg_value_view::on_init_children(void)
{
	...
	p_hr_value->set_value_font_type(c_font::get_font(FONT_ENG_LLLB));
	p_pvsc_value->set_value_font_type(c_font::get_font(FONT_ENG_LLB));
	p_st_ii_value->set_value_font_type(c_font::get_font(FONT_ENG_LLB));
