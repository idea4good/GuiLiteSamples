...
1. Open "HelloCircle\BuildMFC\HelloCircle.sln" by Visual studio 2017
2. Click `F5` to build/run `HelloCircle`
...
## Build
1. Open "HelloCircle\BuildSTM32F103-Keil\USER\HelloCircle.uvprojx" with Keil uvsion.
...
4. Link your LCD driver with GuiLite, and call UI entry function(e.g, startHelloCircle)
5. Build & Run
...
2. Run locally(e.g, Ubuntu):
    - Run with framebuffer: `sudo ./HelloCircle /dev/fb0`&nbsp;&nbsp;&nbsp;&nbsp;/dev/fb0: The path of framebuffer device file.
    - Run inside X Window:
        1. `sudo su`
        2. `sudo ipcrm -M 1`
        3. `sudo ./xWindow 240 320 | ./HelloCircle shared-fb`
...
3. Run on target Linux device:
    ...
    - `sudo ./HelloCircle /dev/fb0`&nbsp;&nbsp;&nbsp;&nbsp;/dev/fb0: The path of framebuffer
