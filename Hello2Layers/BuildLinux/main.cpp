...
"./xWindow 240 320 | ./Hello2Layers shared-fb\n\n"

"Run on ARM Linux:\n"
"./Hello2Layers /dev/fb-path\n"
"------------------------------------------------------------\n";
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh Hello2Layers &");
	...
	init_std_io();
	startHello2Layers(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    return 0;
}
