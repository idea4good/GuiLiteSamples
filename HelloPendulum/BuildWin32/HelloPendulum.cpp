// HelloPendulum.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "UiBlock.h"
#include "HelloPendulum.h"
#include <windowsx.h>
#include <shellapi.h>
...
DWORD WINAPI ThreadHelloPendulum(LPVOID pParam);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HelloPendulum, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HelloPendulum));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HelloPendulum));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HelloPendulum);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD threadID;
   CreateThread(NULL, 0, ThreadHelloPendulum, NULL, 0, &threadID);
