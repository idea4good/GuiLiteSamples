// HelloParticle.cpp : Defines the entry point for the application.
//
...
DWORD WINAPI ThreadHelloParticle(LPVOID pParam);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HelloParticle, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HelloParticle));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HelloParticle));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HelloParticle);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD threadID;
   CreateThread(NULL, 0, ThreadHelloParticle, NULL, 0, &threadID);
