// HelloFreetype.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "UiBlock.h"
#include "HelloFreetype.h"
#include <windowsx.h>
#include <shellapi.h>
...
DWORD WINAPI ThreadHelloFreetype(LPVOID pParam);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HelloFreetype, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HelloFreetype));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HelloFreetype));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HelloFreetype);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD threadID;
   CreateThread(NULL, 0, ThreadHelloFreetype, NULL, 0, &threadID);
...
//////////////////////// HelloFreetype Interface ////////////////////////
extern void startHelloFreetype(void* phy_fb, int width, int height, int color_bytes);

DWORD WINAPI ThreadHelloFreetype(LPVOID pParam)
{
	startHelloFreetype(calloc(800 * 600, COLOR_BYTES), 800, 600, COLOR_BYTES);
	return 0;
}
