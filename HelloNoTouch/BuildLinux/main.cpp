...
"If x64: ./display-x64 | ./HelloNoTouch shared-fb\n"
"If ARM: ./display-arm | ./HelloNoTouch shared-fb\n\n"

"How to run on Linux?\n"
"Type command: ./HelloNoTouch /dev/fb-path\n\n"
"-------------------- Help ------------------------\n"
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh HelloNoTouch");
	...
	init_std_io();
	startHelloNoTouch(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    while(1)
    {
    	sleep(1000);
    }
