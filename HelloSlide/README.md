...
- If ARM/Raspberry Pi: `sudo ./display-arm  1 512 768 | ./HelloSlide shared-fb`
...
2. How to run HelloSlide on ARM Linux device?
- Copy HelloSlide you build on ARM Linux device
