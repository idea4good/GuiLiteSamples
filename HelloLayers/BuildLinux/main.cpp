...
"./xWindow 240 320 | ./HelloLayers shared-fb\n\n"

"Run on ARM Linux:\n"
"./HelloLayers /dev/fb-path\n"
"------------------------------------------------------------\n";
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh HelloLayers > .sync_log.txt 2>&1 &");
	...
	init_std_io();
	startHelloLayers(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    return 0;
}
