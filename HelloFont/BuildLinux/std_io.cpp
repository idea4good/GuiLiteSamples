...
extern void sendTouch2HelloFont(int x, int y, bool is_down);
extern int captureUiOfHelloFont();
...
{
	sendTouch2HelloFont(x, y, true);
}

static void press_release(int x, int y)
{
	sendTouch2HelloFont(x, y, false);
}
