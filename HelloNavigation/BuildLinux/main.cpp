...
"If x64: ./display-x64 | ./HelloNavigation shared-fb\n"
"If ARM: ./display-arm | ./HelloNavigation shared-fb\n\n"

"How to run on Linux?\n"
"Type command: ./HelloNavigation /dev/fb-path\n\n"
"-------------------- Help ------------------------\n"
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh HelloNavigation");
	...
	init_std_io();
	startHelloNavigation(phy_fb, screen_width, screen_height, color_bytes, NULL);//never return;
    while(1)
    {
    	sleep(1000);
    }
