...
2. Run locally(e.g, Ubuntu):
    - Run with framebuffer: `sudo ./HelloNoTouch /dev/fb0`&nbsp;&nbsp;&nbsp;&nbsp;/dev/fb0: The path of framebuffer device file.
    - Run inside X Window: `sudo ./xWindow 240 320 | ./HelloNoTouch shared-fb`
...
3. Run on target Linux device:
    - Copy BuildLinux/HelloNoTouch to target Linux device
    - `chmod 777 HelloNoTouch`
