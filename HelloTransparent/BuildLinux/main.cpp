...
"If x64: ./display-x64 | ./HelloTransparent shared-fb\n"
"If ARM: ./display-arm | ./HelloTransparent shared-fb\n\n"

"How to run on Linux?\n"
"Type command: ./HelloTransparent /dev/fb-path\n\n"
"-------------------- Help ------------------------\n"
"exit: 	Exit the App.\n"
"--------------------------------------------------\n";
