...
- `sudo ./HelloWidgets /dev/fb0`&nbsp;&nbsp;&nbsp;&nbsp;/dev/fb0: The path of framebuffer device file.

3. Run inside QT APP(display-xxx is a QT APP for display, skip this if you haven't installed QT):
- If x64: `sudo ./display-x64 1 680 512 | ./HelloWidgets shared-fb`
- If ARM/Raspberry Pi: `sudo ./display-arm  1 680 512 | ./HelloWidgets shared-fb`
...
2. How to run HelloWidgets on ARM Linux device?
- Copy HelloWidgets you build on ARM Linux device
