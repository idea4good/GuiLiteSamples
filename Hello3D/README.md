...
- `sudo ./Hello3D /dev/fb0`&nbsp;&nbsp;&nbsp;&nbsp;/dev/fb0: The path of framebuffer device file.

3. Run inside QT APP(display-xxx is a QT APP for display, skip this if you haven't installed QT):
- If x64: `sudo ./display-x64 1 500 500 | ./Hello3D shared-fb`
- If ARM/Raspberry Pi: `sudo ./display-arm  1 500 500 | ./Hello3D shared-fb`
...
2. How to run Hello3D on ARM Linux device?
- Copy Hello3D you build on ARM Linux device
