...
1. Open "Hello3Dwave\BuildMFC\Hello3Dwave.sln" by Visual studio 2017
2. Click `F5` to build/run `Hello3Dwave`
...
## Build
1. Open "Hello3Dwave\BuildSTM32F103-Keil\USER\Hello3Dwave.uvprojx" with Keil uvsion.
...
4. Link your LCD driver with GuiLite, and call UI entry function(e.g, startHello3Dwave)
5. Build & Run
...
2. Run locally(e.g, Ubuntu):
    - Run with framebuffer: `sudo ./Hello3Dwave /dev/fb0`&nbsp;&nbsp;&nbsp;&nbsp;/dev/fb0: The path of framebuffer device file.
    - Run inside X Window: `sudo ./xWindow 240 320 | ./Hello3Dwave shared-fb`
...
3. Run on target Linux device:
    - Copy BuildLinux/Hello3Dwave to target Linux device
    - `chmod 777 Hello3Dwave`
    - `sudo ./Hello3Dwave /dev/fb0`&nbsp;&nbsp;&nbsp;&nbsp;/dev/fb0: The path of framebuffer
