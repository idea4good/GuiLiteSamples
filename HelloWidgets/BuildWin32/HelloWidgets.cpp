...
DWORD WINAPI ThreadHelloWidgets(LPVOID pParam);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HelloWidgets, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HelloWidgets));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HelloWidgets));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HelloWidgets);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD threadID;
   CreateThread(NULL, 0, ThreadHelloWidgets, NULL, 0, &threadID);
...
//////////////////////// HelloWidgets Interface ////////////////////////
extern void startHelloWidgets(void* phy_fb, int width, int height, int color_bytes);

DWORD WINAPI ThreadHelloWidgets(LPVOID pParam)
{
	startHelloWidgets(calloc(680 * 512, COLOR_BYTES), 680, 512, COLOR_BYTES);
	return 0;
}
