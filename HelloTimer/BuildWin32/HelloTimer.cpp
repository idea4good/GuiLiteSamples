// HelloTimer.cpp : Defines the entry point for the application.
//
...
DWORD WINAPI ThreadHelloTimer(LPVOID pParam);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HelloTimer, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HelloTimer));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HelloTimer));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HelloTimer);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DWORD threadID;
   CreateThread(NULL, 0, ThreadHelloTimer, NULL, 0, &threadID);
...
DWORD WINAPI ThreadHelloTimer(LPVOID pParam)
{
	startHelloTimer(calloc(240 * 320, COLOR_BYTES), 240, 320, COLOR_BYTES, 0);
	return 0;
}
