...
"If x64: ./display-x64 | ./HelloWidgets shared-fb\n"
"If ARM: ./display-arm | ./HelloWidgets shared-fb\n\n"

"How to run on Linux?\n"
"Type command: ./HelloWidgets /dev/fb-path\n\n"
"-------------------- Help ------------------------\n"
"exit: 	Exit the App.\n"
"--------------------------------------------------\n";
...
int main(int argc, char** argv)
{
	...
	system("./.sync_build.sh HelloWidgets");
	...
	init_std_io();
	startHelloWidgets(phy_fb, screen_width, screen_height, color_bytes);//never return;
    return 0;
}
